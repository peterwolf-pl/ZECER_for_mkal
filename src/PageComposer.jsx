...
import LetterExtractor from "./LetterExtractor";
...
export default function PageComposer({
  ...
  const handleDragEnd = () => {
    ...
    if (dropPos.pos === "merge" && dropPos.targetIdx !== dragIdx) {
      const merged = [
      ...
      if (dragIdx < dropPos.targetIdx && dropPos.pos === "above") {
        insertAt--;
      }
  ...
  return (
    ...
    >
      ...
      >
            ...
            wrapperRef.current && (
              <div
                style={{
                  ...
                  borderRadius: 4 * scale,
                  minHeight:
                    getLineHeight(lines[dragIndex]) * scale,
                }}
              >
                {lines[dragIndex].map((letter, j) => (
                  <img
                    ...
                    alt={letter.char}
                    width={
                      letter.width * LETTER_SCALE * scale
                    }
                    height={
                      (letter.height
                        ? letter.height * LETTER_SCALE
        ...
        >
          {/* Kosz - popup z wyborem */}
          <button
            onClick={() => setShowTrashInfo(true)}
            onMouseDown={(e) => {
              e.currentTarget.style.transform = "translateY(3px)";
              e.currentTarget.style.boxShadow = "2px 2px 1px #777777";
            }}
            ...
            style={{
              ...
              border: "2px solid #ff0000",
                  ...
                  borderRadius: "5",
                  cursor: "pointer",
                  boxShadow: "5px 5px 3px #777",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: 20,
            }}
            title="Nie wyrzucaj czcionek"
            aria-label="Nie wyrzucaj czcionek"
          >
            <span
              style={{
                display: "inline-block",
     ...
     style={{
            ...
            title="Rozkładanie składu zecerskiego"
            aria-label="Rozkładanie składu zecerskiego"
          >
            <span
              style={{
                display: "inline-block",
      ...
      {/* Popup informacyjny dla kosza */}
      {showTrashInfo && (
        <div
          onClick={() => setShowTrashInfo(false)}
          style={{
            position: "fixed",
            inset: 0,
        ...
        >
          ...
          >
            <p style={{ margin: 0, marginBottom: 12 }}>
              Nie można wyrzucać czcionek do kosza!! 
</p><p style={{ margin: 0, marginBottom: 12 }}>
              ROZŁÓŻ CZCIONKI DO ODPOWIEDNICH KRUPEK W KASZCIE.
            </p>
            ...
            >
              ...
              <button
                ...
                title="Rozłóż skład"
                aria-label="Rozłóż skład"
              >
                &#9638; rozłóż skład
              </button>

              {/* Ikona: wyrzuć mimo wszystko */}
              <button
                onClick={() => {
                  setShowTrashInfo(false);
                  if (typeof onClearLines === "function") {
                    onClearLines();
                  } else {
                    onLinesChange([]);
                  }
                ...
                title="Wyrzuć mimo wszystko"
                aria-label="Wyrzuć mimo wszystko"
              >
                &#128465;
              </button>
            </div>
      ...
      >
        <b>ZECER</b> - gra edukacyjna dla Muzeum Książki Artystycznej w Łodzi
        &nbsp; &nbsp; &nbsp; produkcja:{" "}
        <a
